      ...
      <div className="h-screen container mx-auto flex  items-center justify-center text-white">
        ...
        <header className="absolute top-0 left-0 w-full flex justify-between items-center p-5  ">
          ...
          <div className="flex items-center space-x-4">
            <Link
              to={"/admin/login"}
              className="bg-blue-400 hover:bg-white hover:text-black border border-gray-500 py-2 px-4 rounded-md"
            >
              Login
            </Link>
            <Link
              to={"/"}
              className="bg-orange-500 hover:text-black hover:bg-white py-2 px-4 rounded-md"
            >
            Home
            </Link>
          </div>
        ...
        <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-[500px] mt-20">
          ...
          <p className="text-center text-gray-400 mb-6">
            Just Signup to control the dashboard!
          </p>
